document.addEventListener('DOMContentLoaded', () => {
    ...
    document.getElementById('searchButton').addEventListener('click', async () => {
        ...
        if (topThreeNegatives.length > 0) {
            ...
            document.getElementById('poder1').innerText = topThreeNegatives[0] ? (topThreeNegatives[0].power) : '';
            ...
            document.getElementById('poder2').innerText = topThreeNegatives[1] ? (topThreeNegatives[1].power) : '';
            document.getElementById('bonus2').innerText = topThreeNegatives[1] ? `${(topThreeNegatives[1].bonus_percent / 100).toFixed(2)}%` : '';
            ...
            document.getElementById('poder3').innerText = topThreeNegatives[2] ? (topThreeNegatives[2].power) : '';
            document.getElementById('bonus3').innerText = topThreeNegatives[2] ? `${(topThreeNegatives[2].bonus_percent / 100).toFixed(2)}%` : '';
