...
result = data.values.map(row => [
    row[0], 
    row[3] && row[3] !== "" && row[3] !== "#N/A" ? (row[3]*1000).toFixed(0) : row[1],
    row[4] ? row[4].replace('.', ',') : '',
    row[6] && row[6] !== "" && row[6] !== "#N/A" ? (row[6]*1000).toFixed(0) : row[23],
    row[7] ? row[7].replace('.', ',') : '',
    row[9] && row[9] !== "" && row[9] !== "#N/A" ? (row[9]*1000).toFixed(0) : row[24],
    row[10] ? row[10].replace('.', ',') : '',
    row[12] && row[12] !== "" && row[12] !== "#N/A" ? (row[12]*1000).toFixed(0) : row[25],
    row[13] ? row[13].replace('.', ',') : '',
    row[15] && row[15] !== "" && row[15] !== "#N/A" ? (row[15]*1000).toFixed(0) : row[26],
    row[16] ? row[16].replace('.', ',') : '',
    row[18] && row[18] !== "" && row[18] !== "#N/A" ? (row[18]*1000).toFixed(0) : row[27],
    row[19] ? row[19].replace('.', ',') : '',
    row[21] && row[21] !== "" && row[21] !== "#N/A" ? (row[21]*1000).toFixed(0) : row[38],
